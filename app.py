...
def load_mega_market_tickers():
    saham_300_plus = [
        ...
        "WSBP", "WSKT", "WTG",  "WTIA", "YPAS", "YUASA", "YULE", "ZATA", "ZBRA", "ZINC", "ZONE", "PTRO", "BRAM", "IRSX", "WIFI","BNBR","RANS","PRDL","JELI","EMMI","KOKO","MIKA","UVCR","BMHS","RGAS","EMAS","WBSA","KLBV","NCKL","BELI","ULTJ","TMPO", "DSSA","RMKO","RMKE","OMED"
    ]

...
with st.sidebar:
    ...
    saham_pilihan = st.multiselect(
        ...
        default=["MIKA","AKRA","UVCR","BMHS","OMED","SKBM","ADHI","GGRM","ICBP","INDF","DSSA","EMAS","AMMN","TPIA","RBMS","BRMS","ELPI","RGAS","ENRG","MDKA","DEWA","BUMI","CUAN","RMKO","WBSA","IRSX","NZIA","ANTM","BBCA","BBRI","BBNI","BMRI","CPIN","JPFA","CMRY","ISAT","TLKM","JSMR"])

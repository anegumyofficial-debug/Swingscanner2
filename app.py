...
def load_mega_market_tickers():
    saham_300_plus = [
        ...
        "WSBP", "WSKT", "WTG",  "WTIA", "YPAS", "YUASA", "YULE", "ZATA", "ZBRA", "ZINC", "ZONE", "PTRO", "BRAM", "IRSX", "WIFI","RANS","PDRL","JELI","EMMI","KOKO","MIKA","UVCR","BMHS","RGAS","EMAS","WBSA","KLBV","NCKL","BELI","ULTJ","TMPO", "DSSA","RMKO","RMKE","ELPI","OMED"
    ]
...
with st.sidebar:
    ...
    saham_pilihan = st.multiselect(
        ...
        default=["FORU","RANS","PDRL","JELI","EMMI","KOKO","MIKA","AKRA","UVCR","BMHS","COCO","OMED","SKBM","ADHI","GGRM","ICBP","INDF","DSSA","EMAS","AMMN","TPIA","RBMS","BRMS","ELPI","RGAS","ENRG","MDKA","DEWA","BUMI","CUAN","RMKO","WBSA","IRSX","NZIA","ANTM","BBCA","BBRI","BBNI","BMRI","CPIN","JPFA","CMRY","ISAT","TLKM","JSMR"])

...
def load_mega_market_tickers():
    saham_300_plus = [
        ...
        "WSBP", "WSKT", "WTG",  "WTIA", "YPAS", "YUASA", "YULE", "ZATA", "ZBRA", "ZINC", "ZONE", "PTRO", "BRAM", "IRSX", "WIFI","BMHS","MIKA","UVCR","RGAS","EMAS","WBSA","KLBV","NCKL","BELI","ULTJ","TMPO", "DSSA","RMKO","RMKE","ELPI","OMED"
    ]
